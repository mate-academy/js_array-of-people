...
function arrayOfPeople(people) {
  ...
  for (const visitor of people) {
    const positionInTheRoom = roomVisitors.indexOf(visitor);

    if (positionInTheRoom === -1) {
      roomVisitors.push(visitor);
    } else {
      roomVisitors.splice(positionInTheRoom, 1);
    }
  }
